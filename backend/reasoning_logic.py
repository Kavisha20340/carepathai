...
6. STRICT CLINICAL GROUNDING: You MUST NEVER hallucinate, infer, or add unstated symptoms or body locations (e.g., do NOT infer 'Throat' for sneezing or general chills unless explicitly reported by the user). If a specific body location was not explicitly mentioned by the user, body_location MUST be null.
